...
#ifndef YY_YY_LALR_HXX_INCLUDED
# define YY_YY_LALR_HXX_INCLUDED
// //                    "%code requires" blocks.
#line 17 "lalr.y" // lalr1.cc:377
...
namespace yy {
#line 130 "lalr.hxx" // lalr1.cc:377
  ...
  public:
    ...
    {
      // attr_stmt
      char dummy1[sizeof(AttrStmt)];

      // decl_list
      char dummy2[sizeof(DecList)];
      ...
      // stmt_list
      char dummy7[sizeof(StmtList)];

      // decl_stmt
      char dummy8[sizeof(VarDec)];
  ...
  basic_symbol (typename Base::kind_type t, const AttrStmt v, const location_type& l);

  basic_symbol (typename Base::kind_type t, const DecList v, const location_type& l);
  ...
  basic_symbol (typename Base::kind_type t, const VarDec v, const location_type& l);
  ...
  basic_symbol (typename Base::kind_type t, const std::vector<std::string> v, const location_type& l);
    ...
    static inline
    symbol_type
    make_CHAR_TYPE (const location_type& l);
    ...
    static inline
    symbol_type
    make_EXITWHEN (const location_type& l);
    ...
    static inline
    symbol_type
    make_PUT (const location_type& l);
    ...
    static inline
    symbol_type
    make_ATTR_SIGN (const location_type& l);

    static inline
    symbol_type
    make_DIFF_SIGN (const location_type& l);

    static inline
    symbol_type
    make_GREATER_EQ_SIGN (const location_type& l);

    static inline
    symbol_type
    make_LESS_EQ_SIGN (const location_type& l);
...
#line 865 "lalr.hxx" // lalr1.cc:377




#endif // !YY_YY_LALR_HXX_INCLUDED
